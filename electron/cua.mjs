...
//    EmbeddedCuaDriverHost so TCC grants attribute to XinyunOpen Bot and the
//    driver inherits them. One prompt, named XinyunOpen Bot, out of the box.
...
const HOST_BUNDLE_ID = "com.dongpen.xinyunopenbot";
